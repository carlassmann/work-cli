...
export const commandSpecs = [
  ...
  { name: "up", summary: "Start workspace commands.", flags: ["--create", "--no-create", "--remote", "--cloudflare"] },
  { name: "setup", summary: "Run the workspace setup hook.", flags: ["--cloudflare"] },
  { name: "down", summary: "Stop workspace commands.", flags: ["-a", "--all", "-p", "--project"] },
  { name: "run", summary: "Start one configured command.", flags: ["-w", "--workspace", "--cloudflare"] },
  { name: "restart", summary: "Restart commands.", flags: ["-a", "--all", "-p", "--project", "-w", "--workspace", "--cloudflare"] },
